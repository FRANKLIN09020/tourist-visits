  ...
  return (
    ...
    <Container id="Home" >
      <Row>
       ...
       <Carousel>
      <Carousel.Item>
      <Image src={require("../Assets/banner1.jpg" )} alt="Banner" className='d-block w-100'  height={550}></Image>
      </Carousel.Item>
      <Carousel.Item>
      <Image src={require("../Assets/pic1.jpeg")} alt="Banner"  className='d-block w-100' height={550}></Image>
      </Carousel.Item>
      <Carousel.Item>
      <Image src={require("../Assets/pic2.jpeg")} alt="Banner"  className='d-block w-100' height={550}></Image>
      </Carousel.Item>
      <Carousel.Item>
      <Image src={require("../Assets/pic3.jpeg")} alt="Banner"  className='d-block w-100' height={550}></Image>
        </Carousel.Item>
    <Carousel.Item>
      <Image src={require("../Assets/pic4.jpeg")} alt="Banner"  className='d-block w-100' height={550}></Image>
      </Carousel.Item>
      </Carousel>
       </Col>
      </Row>
...
<br /> <br /></span>
    ...
    <Row>
      <Col className='mt-5'>
       <ul >
        <li className="text-center ">Hogenakkal</li>
        <li className='d-flex justify-content-center' >Tourist Places Visit</li>
       </ul>
       </Col>
       </Row>
       <Col className='d-lg-flex mt-5 '>
       <Image src={require("../Assets/hogenakkal1.jpeg")} className='d-block w-25 '></Image>
       <p className='mx-lg-3 mt-4 ' style={{textAlign:"justify"}}>
        <h6 >Theerthamalai Temple, Overview</h6>
        <span className='ps-5'>
...
Theerthagireeswar, 2 form of Lord Shiva is the worshipping deity.
 <br /> <br /></span>
        <span className='ps-5'>tis believed that Lord Ram worshipped Lord Shiva at this temple to absolve him of the sin of kiling so many demas, after his victory
...
five springs in the temple. This temple was built during 7th Century when the Cholas and the Pandya's were ruling this dynasty.<br /> <br /> </span>
       </p>
       </Col>

       <Col className='d-lg-flex mt-5 '>
       <p className='mx-lg-3' style={{textAlign:"justify"}}>
        <h6 >Hogenakkal Falls, Overview</h6>
        <span className='ps-5'>
...
<br /> <br /> </span>
       ...
       <Image src={require("../Assets/hogenakkal2..jpeg")} className='d-block w-25'></Image>
       </Col>

       <Col className='d-lg-flex mt-5 '>
       <Image src={require("../Assets/hogenakkal3.jpeg")} className='d-block w-25 '></Image>
       <p className='mx-lg-3 mt-4 ' style={{textAlign:"justify"}}>
        <h6 >Pennagram Village, Overview</h6>
        <span className='ps-5'>
...
<br /> <br /></span>
        <span className='ps-5'>According to census 2011 information the sub-district code of Pennagaram Block (CD) is 05889. Total area of pennagaram taluka is 1.130
...
<br /> <br /></span>
       ...
       <Image src={require("../Assets/hokenakkal4..jpeg")} className='d-block w-25'></Image>
       </Col>
    </Container>
    </>
